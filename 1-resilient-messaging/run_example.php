...
echo "Ecotone stworzy dla Ciebie kolejkę w RabbitMQ (http://localhost:15672/#/queues) oraz serializuje/odserializuje wiadomości. Błąd przetwarzania wiadomości wystąpi cztery razy.\n\n";
